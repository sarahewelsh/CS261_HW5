...
class MinHeap:
    ...
    def build_heap(self, da: DynamicArray) -> None:
        ...
        curr_index = (self.heap.length()//2) - 1
        left_child_index = ((curr_index * 2) + 1)
        if ((curr_index * 2) + 2) < self.heap.length():
            right_child_index = ((curr_index * 2) + 2)
        else:
            right_child_index = curr_index * 2
        ...
        while curr_index >= 0:
            ...
            if right_child_index < left_child_index:
                if self.heap.get_at_index(curr_index) > self.heap.get_at_index(left_child_index):
                    ...
                    if curr_index < 0:
                        break
            elif self.heap.get_at_index(curr_index) < self.heap.get_at_index(left_child_index) and self.heap.get_at_index(curr_index) < self.heap.get_at_index(right_child_index):
                curr_index = curr_index - 1
                left_child_index = (curr_index * 2) + 1
                right_child_index = (curr_index * 2) + 2

            elif self.heap.get_at_index(curr_index) > self.heap.get_at_index(left_child_index):
                if self.heap.get_at_index(right_child_index) < self.heap.get_at_index(left_child_index):
                    self.heap.swap(curr_index, right_child_index)
                    old_curr = curr_index
                    curr_index = right_child_index
                    if (curr_index * 2) + 2 < self.heap.length():
                        left_child_index = (curr_index * 2) + 1
                        right_child_index = (curr_index * 2) + 2
                        if self.heap.get_at_index(curr_index) < self.heap.get_at_index(left_child_index) and self.heap.get_at_index(curr_index) < self.heap.get_at_index(right_child_index):
                            curr_index = old_curr - 1
                            left_child_index = (curr_index * 2) + 1
                            right_child_index = (curr_index * 2) + 2
                    elif (curr_index * 2) + 1 < self.heap.length():
                        left_child_index = (curr_index * 2) + 1
                        if self.heap.get_at_index(curr_index) < self.heap.get_at_index(left_child_index):
                            curr_index = old_curr - 1
                            left_child_index = (curr_index * 2) + 1
            ...
            elif self.heap.get_at_index(curr_index) > self.heap.get_at_index(right_child_index):
